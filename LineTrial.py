...
stock_image = PhotoImage(file="stockimage.png")

# Create and set the message text variable
message_text2 = StringVar()
message_text2.set("Welcome! You can deposit or withdraw money and see your progress towards your goals.")

# Create and pack the message label
message_label2 = ttk.Label(right_frame, textvariable=message_text2, wraplength=250)
message_label2.grid(row=1, column=0, columnspan=2, padx=10, pady=10)

image_label2 = ttk.Label(right_frame, image=stock_image)
image_label2.grid(row=1, column=1, columnspan=2, padx=10, pady=10)
...
left_frame.grid(row=0, column=2, padx=10, pady=10, sticky="NSEW")

image_label3 = ttk.Label(left_frame, image=stock_image)
image_label3.grid(row=1, column=2, columnspan=2, padx=10, pady=10)


# Create the bottom frame
bottom_frame = ttk.LabelFrame(root)
bottom_frame.grid(row=1, column=2, padx=10, pady=10, sticky="NSEW")

# Create a label for the amount field and pack it into the GUI
amount_label = ttk.Label(bottom_frame, text="Sell:")
amount_label.grid(row=5, column=2, padx=10, pady=3)

# Create the bottom frame
bottom_frame = ttk.LabelFrame(root)
bottom_frame.grid(row=1, column=1, padx=10, pady=10, sticky="NSEW")
...
neutral_image = PhotoImage(file="book_PNG51090.png")
happy_image = PhotoImage(file="Capture3.PNG")
sad_image = PhotoImage(file="Capture2.PNG")
